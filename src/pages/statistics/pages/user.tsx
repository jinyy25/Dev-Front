...
import DataGrid, {Column, DataGridTypes, Pager, Paging} from "devextreme-react/data-grid";
...
export default function User(){
    ...
    const searchSubmit = () => {
        ...
        const response = POST("/api/stat/statuser",body, {headers:{'Authorization': 'Bearer ' + authCtx.token}});
...
return(
    <React.Fragment>
        <div className={'content-block dx-card padding-option'}>
                        <div className="dx-fieldset card-outline">
                            <Box direction="col" width="100%" height={150}>
                                <Item ratio={1}>
                                    <h4 className="card-title">접속사용자별 승인현황</h4>
                                </Item>
                                <Item ratio={1} >
        ...
        <div className={'content-block dx-card responsive-paddings'}>
            ...
            <DataGrid dataSource={resultList} showBorders={true} hoverStateEnabled={true} keyExpr="userId" >
                    ...
                    <Column dataField="userName" caption="사용자" width='10%'/>
                    <Column dataField="totalCnt" caption="총건수" width='6%' />
